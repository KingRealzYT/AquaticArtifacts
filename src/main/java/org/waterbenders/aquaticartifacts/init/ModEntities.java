...
public class ModEntities
{
    ...
    public static final EntityType<HeavyBoat> TYPE_HEAVY_BOAT = EntityType.Builder.of(HeavyBoat::new, EntityClassification.MISC).sized(1.0F, 0.5F).build("aquatic_artifacts:heavy_boat");
